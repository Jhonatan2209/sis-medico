        ...
        <div class="contenedor-perfil">
            ...
            <div class="menu-perfil">
                <ul>
                    ...
                    <li><a href="#" title=""><i
                                class="icono-perfil fas fa-info-circle"></i><?php echo $fila['rol']; ?></a></li>
                    <li><a href="#" title=""><i class="icono-perfil fas fa-grin"></i><?php echo $fila['correo']; ?></a>
                    </li>
                    <li><a href="#" title=""><i class="icono-perfil fas fa-camera"></i><?php echo $fila['fecha']; ?></a>
                    </li>
                </ul>
            </div>
        </div>
